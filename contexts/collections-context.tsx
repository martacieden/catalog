...
const createDemoCollections = (): Collection[] => {
  ...
  return [
    // Main Aviation Collection
    {
      id: 'aviation-main',
      name: 'Aviation',
      description: 'Complete aviation assets and operations management',
      icon: '✈️',
      type: 'manual' as const,
      category: 'Transportation',
      tags: ['aviation', 'fleet', 'operations'],
      items: aviationItems,
      filters: [],
      autoSync: true,
      parentId: null,
    ...
    // Fleet Subcollection
    {
      id: 'aviation-fleet',
      name: 'Fleet',
      description: 'Active aircraft and helicopters in service',
      icon: '🛩️',
      type: 'manual' as const,
      category: 'Fleet Management',
      tags: ['fleet', 'active', 'aircraft'],
      items: fleetItems,
      filters: [],
      autoSync: false,
      parentId: 'aviation-main',
      subcollections: [],
      depth: 1,
    ...
    // Maintenance Subcollection
    {
      ...
      name: 'Maintenance',
      description: 'Maintenance schedules and ongoing work',
      icon: '🔧',
      type: 'manual' as const,
      category: 'Maintenance',
      tags: ['maintenance', 'repairs', 'schedules'],
    ...
    // Legal Documents Collection (for dependencies)
    {
      id: 'legal-docs-main',
      name: 'Legal Documents',
      description: 'Legal documentation and compliance records',
      icon: '📋',
      type: 'manual' as const,
      category: 'Legal',
    ...
    // Insurance Collection (for dependencies)
    {
      id: 'insurance-main',
      name: 'Insurance Policies',
      description: 'Insurance coverage and policy management',
      icon: '🛡️',
      type: 'manual' as const,
      category: 'Insurance',
      tags: ['insurance', 'policies', 'coverage'],
      ...
      updatedAt: now,
      createdBy: currentUser,
      itemCount: insuranceItems.length,
      viewCount: 0,
    }
  ]
}
